...
export const DefaultSVG = ({ children, width, height }) => (
  <svg
    version="1.1"
...
export const EnergyGrowthSVG = ({ color }) => (
  <DefaultSVG>
    <path
      style={{ fill: color || colors.muted }}
