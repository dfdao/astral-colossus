...
interface DaoContractPlayerInterface extends ethers.utils.Interface {
  functions: {
...
export class DaoContractPlayer extends BaseContract {
  ...
  interface: DaoContractPlayerInterface;
