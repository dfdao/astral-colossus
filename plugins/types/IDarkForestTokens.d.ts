...
interface IDarkForestTokensInterface extends ethers.utils.Interface {
  functions: {
...
export class IDarkForestTokens extends BaseContract {
  ...
  interface: IDarkForestTokensInterface;
